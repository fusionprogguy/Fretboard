...
steps = ['1', 'b2', '2', 'b3', '3', '4', 'b5', '5', 'b6', '6', 'b7', '7', '1', 'b9', '9', 'b10', '10', '11', 'b12',
         '12', 'b13', '13', 'b14', '14', 'b15', '15']
steps_sharp = ['1', '#1', '2', '#2', '3', '4', '#4', '5', '#5', '6', '#6', '7', '1', '#8', '9', '#9', '10', '11', '#11',
         '12', '#12', '13', '#13', '14', '#14', '15']
steps_octave = ['1', 'b2', '2', 'b3', '3', '4', 'b5', '5', 'b6', '6', 'b7', '7', '8', 'b9', '9', 'b10', '10', '11',
